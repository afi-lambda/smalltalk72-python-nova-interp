...
def register_all(st: 'ST72'):
    ...
    prims = [
        ...
        ("put",         prim_put,         True),
        ("get",         prim_get,         True),
        ("getvec",      prim_get,         True),
        ("quot",        prim_quot,        True),
        ("ev",          prim_quot,        True),
        ("apply",       prim_quot,        True),
        ("evapply",     prim_quot,        True),
        ("expand",      prim_quot,        True),
        ...
        ("core",        prim_rself,       True),
        ("cr",          prim_rself,       True),
        ("is",          prim_eq,          True),
        ("#",           prim_eq,          True),
        ("-",           prim_number,      True),
        ("nprint",      prim_number,      True),
        ("class",       prim_to,          True),
        ("number",      prim_number,      True),
        ("atom",        prim_atom,        True),
        ("string",      prim_atom,        True),
